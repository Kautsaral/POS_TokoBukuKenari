...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;">Toko<span class="text-primary">Kenari</span></h1>
        ...
        <div class="text-center small mt-4">
            <p class="text-muted">Aplikasi kasir © <?php echo date('Y');?> - By : <a href="" class="span text-primary">TIM 2</a></p>
        </div>
    </div>
